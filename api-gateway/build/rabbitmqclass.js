...
exports.rabbitMqclass = void 0;
//using config file as per environment
let environment = process.env.NODE_ENV;
let configFileName = `config-${environment}`;
let dict_rabbit_mq_connections;
dict_rabbit_mq_connections = new Array();
...
class rabbitMqclass {
    constructor() {
        this.exchangeARNMap = {};
        this.queueURLMap = {};
        this.serviceMethodExchangesMap = {};
    ...
    publishMessageToExchanges(serviceName, exchangeName, methodName, message, id) {
    ...
    async publishMessageToExchange(exchangeName, message, id) {
        // Create connection
        // Create connection
    ...
    async listenToService(exchangeName, serviceName, callBack) {
    ...
    */
    ...
    sendRabbitMQ(queueName, data, id) {
...
exports.rabbitMqclass = rabbitMqclass;
//# sourceMappingURL=rabbitmqclass.js.map