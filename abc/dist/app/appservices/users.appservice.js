...
let UsersAppService = class UsersAppService extends AppServiceBase_1.default {
    constructor(usersRepository, http) {
        super(http, usersRepository, users_1.User, users_1.User, usersDto_1.UsersDto, dto.usersentityJson, dto.usersdtoJson, dto.usersentityToDtoJson, dto.usersdtoToEntityJson);
...
UsersAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(users_1.User)),
