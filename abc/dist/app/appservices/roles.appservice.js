...
let RolesAppService = class RolesAppService extends AppServiceBase_1.default {
    constructor(rolesRepository, http) {
        super(http, rolesRepository, roles_1.Role, roles_1.Role, rolesDto_1.RolesDto, dto.rolesentityJson, dto.rolesdtoJson, dto.rolesentityToDtoJson, dto.rolesdtoToEntityJson);
...
RolesAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(roles_1.Role)),
