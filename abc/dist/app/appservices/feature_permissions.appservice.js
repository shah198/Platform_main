...
let Feature_PermissionsAppService = class Feature_PermissionsAppService extends AppServiceBase_1.default {
    constructor(feature_permissionsRepository, http) {
        super(http, feature_permissionsRepository, feature_permissions_1.Feature_Permission, feature_permissions_1.Feature_Permission, feature_permissionsDto_1.Feature_PermissionsDto, dto.feature_permissionsentityJson, dto.feature_permissionsdtoJson, dto.feature_permissionsentityToDtoJson, dto.feature_permissionsdtoToEntityJson);
...
Feature_PermissionsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(feature_permissions_1.Feature_Permission)),
