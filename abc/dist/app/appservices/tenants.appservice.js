...
let TenantsAppService = class TenantsAppService extends AppServiceBase_1.default {
    constructor(tenantsRepository, http) {
        super(http, tenantsRepository, tenants_1.Tenant, tenants_1.Tenant, tenantsDto_1.TenantsDto, dto.tenantsentityJson, dto.tenantsdtoJson, dto.tenantsentityToDtoJson, dto.tenantsdtoToEntityJson);
...
TenantsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tenants_1.Tenant)),
