...
let AppsAppService = class AppsAppService extends AppServiceBase_1.default {
    constructor(appsRepository, http) {
        super(http, appsRepository, apps_1.App, apps_1.App, appsDto_1.AppsDto, dto.appsentityJson, dto.appsdtoJson, dto.appsentityToDtoJson, dto.appsdtoToEntityJson);
...
AppsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(apps_1.App)),
