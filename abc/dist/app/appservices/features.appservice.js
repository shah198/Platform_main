...
let FeaturesAppService = class FeaturesAppService extends AppServiceBase_1.default {
    constructor(featuresRepository, http) {
        super(http, featuresRepository, features_1.Feature, features_1.Feature, featuresDto_1.FeaturesDto, dto.featuresentityJson, dto.featuresdtoJson, dto.featuresentityToDtoJson, dto.featuresdtoToEntityJson);
...
FeaturesAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(features_1.Feature)),
