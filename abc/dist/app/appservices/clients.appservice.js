...
let ClientsAppService = class ClientsAppService extends AppServiceBase_1.default {
    constructor(clientsRepository, http) {
        super(http, clientsRepository, clients_1.Client, clients_1.Client, clientsDto_1.ClientsDto, dto.clientsentityJson, dto.clientsdtoJson, dto.clientsentityToDtoJson, dto.clientsdtoToEntityJson);
...
ClientsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(clients_1.Client)),
