...
let Tenant_UsersAppService = class Tenant_UsersAppService extends AppServiceBase_1.default {
    constructor(tenant_usersRepository, http) {
        super(http, tenant_usersRepository, tenant_users_1.Tenant_User, tenant_users_1.Tenant_User, tenant_usersDto_1.Tenant_UsersDto, dto.tenant_usersentityJson, dto.tenant_usersdtoJson, dto.tenant_usersentityToDtoJson, dto.tenant_usersdtoToEntityJson);
...
Tenant_UsersAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tenant_users_1.Tenant_User)),
