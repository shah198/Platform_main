...
let App_RolesAppService = class App_RolesAppService extends AppServiceBase_1.default {
    constructor(app_rolesRepository, http) {
        super(http, app_rolesRepository, app_roles_1.App_Role, app_roles_1.App_Role, app_rolesDto_1.App_RolesDto, dto.app_rolesentityJson, dto.app_rolesdtoJson, dto.app_rolesentityToDtoJson, dto.app_rolesdtoToEntityJson);
...
App_RolesAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(app_roles_1.App_Role)),
