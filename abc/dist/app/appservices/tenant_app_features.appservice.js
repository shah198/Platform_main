...
let Tenant_App_FeaturesAppService = class Tenant_App_FeaturesAppService extends AppServiceBase_1.default {
    constructor(tenant_app_featuresRepository, http) {
        super(http, tenant_app_featuresRepository, tenant_app_features_1.Tenant_App_Feature, tenant_app_features_1.Tenant_App_Feature, tenant_app_featuresDto_1.Tenant_App_FeaturesDto, dto.tenant_app_featuresentityJson, dto.tenant_app_featuresdtoJson, dto.tenant_app_featuresentityToDtoJson, dto.tenant_app_featuresdtoToEntityJson);
...
Tenant_App_FeaturesAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tenant_app_features_1.Tenant_App_Feature)),
