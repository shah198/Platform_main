...
let Tenant_User_App_AlertsAppService = class Tenant_User_App_AlertsAppService extends AppServiceBase_1.default {
    constructor(tenant_user_app_alertsRepository, http) {
        super(http, tenant_user_app_alertsRepository, tenant_user_app_alerts_1.Tenant_User_App_Alert, tenant_user_app_alerts_1.Tenant_User_App_Alert, tenant_user_app_alertsDto_1.Tenant_User_App_AlertsDto, dto.tenant_user_app_alertsentityJson, dto.tenant_user_app_alertsdtoJson, dto.tenant_user_app_alertsentityToDtoJson, dto.tenant_user_app_alertsdtoToEntityJson);
...
Tenant_User_App_AlertsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tenant_user_app_alerts_1.Tenant_User_App_Alert)),
