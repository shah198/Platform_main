...
const tenant_appsDto_1 = require("../../submodules/Ecommerce-Platform-Dtos/tenant_appsDto");
...
let Tenant_AppsAppService = class Tenant_AppsAppService extends AppServiceBase_1.default {
    constructor(tenant_appsRepository, http) {
        super(http, tenant_appsRepository, tenant_apps_1.Tenant_App, tenant_apps_1.Tenant_App, tenant_appsDto_1.Tenant_AppsDto, dto.tenant_appsentityJson, dto.tenant_appsdtoJson, dto.tenant_appsentityToDtoJson, dto.tenant_appsdtoToEntityJson);
...
Tenant_AppsAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tenant_apps_1.Tenant_App)),
