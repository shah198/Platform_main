...
const tenants_1 = require("../submodules/Ecommerce-Platform-Entities/tenants");
...
const tenant_user_app_roles_1 = require("../submodules/Ecommerce-Platform-Entities/tenant_user_app_roles");
const tenant_user_app_alerts_1 = require("../submodules/Ecommerce-Platform-Entities/tenant_user_app_alerts");
const tenant_user_apps_1 = require("../submodules/Ecommerce-Platform-Entities/tenant_user_apps");
const tenant_users_1 = require("../submodules/Ecommerce-Platform-Entities/tenant_users");
const tenant_apps_1 = require("../submodules/Ecommerce-Platform-Entities/tenant_apps");
const tenant_app_features_1 = require("../submodules/Ecommerce-Platform-Entities/tenant_app_features");
const roles_1 = require("../submodules/Ecommerce-Platform-Entities/roles");
const features_1 = require("../submodules/Ecommerce-Platform-Entities/features");
const feature_permissions_1 = require("../submodules/Ecommerce-Platform-Entities/feature_permissions");
const clients_1 = require("../submodules/Ecommerce-Platform-Entities/clients");
const apps_1 = require("../submodules/Ecommerce-Platform-Entities/apps");
const app_roles_1 = require("../submodules/Ecommerce-Platform-Entities/app_roles");
const app_messages_1 = require("../submodules/Ecommerce-Platform-Entities/app_messages");
...
const addresses_entity_1 = require("../submodules/Ecommerce-Platform-Entities/addresses.entity");
    ...
    common_1.Module({
        imports: [common_1.HttpModule,
            typeorm_1.TypeOrmModule.forFeature([users_1.User,
                tenants_1.Tenant,
                tenant_users_1.Tenant_User,
                tenant_user_apps_1.Tenant_User_App,
                tenant_user_app_roles_1.Tenant_User_App_Role,
                tenant_user_app_alerts_1.Tenant_User_App_Alert,
                tenant_apps_1.Tenant_App,
                tenant_app_features_1.Tenant_App_Feature,
                roles_1.Role,
                features_1.Feature,
                feature_permissions_1.Feature_Permission,
                clients_1.Client,
                apps_1.App,
                app_roles_1.App_Role,
                app_messages_1.App_Message,
                cities_entity_1.City,
                countries_entity_1.Country,
                states_entity_1.State,
                addresses_entity_1.Address,
            ]),
        ],
