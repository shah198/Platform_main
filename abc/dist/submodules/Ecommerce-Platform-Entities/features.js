...
__decorate([
    typeorm_1.ManyToOne((type) => apps_1.App, (apps) => apps.id),
    typeorm_1.JoinColumn({ name: "app_id" }),
    __metadata("design:type", Array)
], Feature.prototype, "apps", void 0);
__decorate([
    typeorm_1.OneToMany((type) => feature_permissions_1.Feature_Permission, (feature_permissions) => feature_permissions.features),
    __metadata("design:type", Array)
], Feature.prototype, "feature_permissions", void 0);
__decorate([
    typeorm_1.OneToMany((type) => feature_permissions_1.Feature_Permission, (tenant_app_feature) => tenant_app_feature.features),
    __metadata("design:type", Array)
