...
__decorate([
    typeorm_1.ManyToOne((type) => apps_1.App, (App) => App.id),
    typeorm_1.JoinColumn({ name: "app_id" }),
    __metadata("design:type", Array)
], Tenant_App.prototype, "apps", void 0);
__decorate([
    typeorm_1.ManyToOne((type) => tenants_1.Tenant, (Tenant) => Tenant.id),
    typeorm_1.JoinColumn({ name: "tenant_id" }),
    __metadata("design:type", Array)
], Tenant_App.prototype, "tenants", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_app_features_1.Tenant_App_Feature, (tenant_app_features) => tenant_app_features.tenant_apps),
    __metadata("design:type", Array)
], Tenant_App.prototype, "tenant_app_features", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_user_apps_1.Tenant_User_App, (tenant_user_apps) => tenant_user_apps.tenant_apps),
    __metadata("design:type", Array)
