...
__decorate([
    typeorm_1.Column({ name: "login_name", nullable: false }),
...
__decorate([
    typeorm_1.Column({ name: "email", nullable: false }),
    __metadata("design:type", String)
], User.prototype, "email", void 0);
__decorate([
    typeorm_1.Column({ name: "phone", nullable: false }),
    __metadata("design:type", Number)
], User.prototype, "phone", void 0);
__decorate([
    typeorm_1.Column({ name: "marital_status", nullable: false }),
    __metadata("design:type", String)
], User.prototype, "marital_status", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_users_1.Tenant_User, (tenant_users) => tenant_users.users),
    __metadata("design:type", Array)
], User.prototype, "tenant_users", void 0);
__decorate([
    typeorm_1.OneToMany((type) => feature_permissions_1.Feature_Permission, (feature_permissions) => feature_permissions.users),
    __metadata("design:type", Array)
], User.prototype, "feature_permissions", void 0);
User = __decorate([
    typeorm_1.Entity('users', { "schema": "platform" }),
    typeorm_1.Unique(["id"])
], User);
exports.User = User;
