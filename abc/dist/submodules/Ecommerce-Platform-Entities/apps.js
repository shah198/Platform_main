...
__decorate([
    typeorm_1.OneToMany((type) => app_messages_1.App_Message, (app_message) => app_message.apps),
    __metadata("design:type", Array)
], App.prototype, "app_message", void 0);
__decorate([
    typeorm_1.OneToMany((type) => features_1.Feature, (features) => features.apps),
    __metadata("design:type", Array)
], App.prototype, "features", void 0);
__decorate([
    typeorm_1.OneToMany((type) => app_roles_1.App_Role, (app_roles) => app_roles.apps),
    __metadata("design:type", Array)
], App.prototype, "app_roles", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_apps_1.Tenant_App, (tenant_apps) => tenant_apps.apps),
    __metadata("design:type", Array)
