...
__decorate([
    typeorm_1.OneToMany((type) => feature_permissions_1.Feature_Permission, (feature_permissions) => feature_permissions.roles),
    __metadata("design:type", Array)
], Role.prototype, "feature_permissions", void 0);
__decorate([
    typeorm_1.OneToMany((type) => app_roles_1.App_Role, (app_roles) => app_roles.roles),
    __metadata("design:type", Array)
], Role.prototype, "app_roles", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_user_app_roles_1.Tenant_User_App_Role, (tenant_user_app_roles) => tenant_user_app_roles.roles),
    __metadata("design:type", Array)
