...
__decorate([
    typeorm_1.Column({ name: "alert_type", nullable: false }),
    __metadata("design:type", String)
], Tenant_User_App_Alert.prototype, "alert_type", void 0);
__decorate([
    typeorm_1.Column({ name: "alert_name", nullable: false }),
    __metadata("design:type", String)
...
__decorate([
    typeorm_1.Column({ name: "from_date_time", nullable: false }),
...
__decorate([
    typeorm_1.Column({ name: "subscription_date", nullable: false }),
    __metadata("design:type", Date)
], Tenant_User_App_Alert.prototype, "subscription_date", void 0);
__decorate([
    typeorm_1.Column({ name: "has_unsubscribed", nullable: false }),
...
__decorate([
    typeorm_1.ManyToOne((type) => tenant_user_apps_1.Tenant_User_App, (tenant_user_apps) => tenant_user_apps.id),
...
Tenant_User_App_Alert = __decorate([
    typeorm_1.Entity('tenant_user_app_alerts', { "schema": "platform" }),
    typeorm_1.Unique(["id"])
