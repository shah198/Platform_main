...
__decorate([
    typeorm_1.Column({ name: "identity_providers_details", type: "json", nullable: false }),
...
__decorate([
    typeorm_1.OneToMany((type) => tenant_users_1.Tenant_User, (tenant_users) => tenant_users.tenants),
    __metadata("design:type", Array)
], Tenant.prototype, "tenant_users", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_apps_1.Tenant_App, (tenant_apps) => tenant_apps.tenants),
    __metadata("design:type", Array)
], Tenant.prototype, "tenant_apps", void 0);
__decorate([
    typeorm_1.ManyToOne((type) => clients_1.Client, (ClientsEntity) => ClientsEntity.id),
