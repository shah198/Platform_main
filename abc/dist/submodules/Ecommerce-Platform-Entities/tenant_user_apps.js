...
__decorate([
    typeorm_1.ManyToOne((type) => tenant_apps_1.Tenant_App, (tenant_apps) => tenant_apps.id),
    typeorm_1.JoinColumn({ name: "tenant_app_id" }),
    __metadata("design:type", Array)
], Tenant_User_App.prototype, "tenant_apps", void 0);
__decorate([
    typeorm_1.ManyToOne((type) => tenant_users_1.Tenant_User, (tenant_users) => tenant_users.id),
    typeorm_1.JoinColumn({ name: "tenant_user_id" }),
    __metadata("design:type", Array)
], Tenant_User_App.prototype, "tenant_users", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_user_app_alerts_1.Tenant_User_App_Alert, (tenant_user_app_alerts) => tenant_user_app_alerts.tenant_user_apps),
    __metadata("design:type", Array)
], Tenant_User_App.prototype, "tenant_user_app_alert", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_user_app_roles_1.Tenant_User_App_Role, (tenant_user_app_roles) => tenant_user_app_roles.tenant_user_apps),
    __metadata("design:type", Array)
