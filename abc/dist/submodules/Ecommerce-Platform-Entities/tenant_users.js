...
__decorate([
    typeorm_1.ManyToOne((type) => tenants_1.Tenant, (tenants) => tenants.id),
    typeorm_1.JoinColumn({ name: "tenant_Id" }),
    __metadata("design:type", Array)
], Tenant_User.prototype, "tenants", void 0);
__decorate([
    typeorm_1.OneToMany((type) => tenant_user_apps_1.Tenant_User_App, (tenant_user_apps) => tenant_user_apps.tenant_users),
    __metadata("design:type", Array)
